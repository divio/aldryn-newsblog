...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'NewsBlogLatestArticlesPlugin.exclude_featured'
        db.add_column(u'aldryn_newsblog_newsbloglatestarticlesplugin', 'exclude_featured',
                      self.gf('django.db.models.fields.PositiveSmallIntegerField')(default=0, blank=True),
                      keep_default=False)

        # Adding field 'NewsBlogConfig.exclude_featured'
        db.add_column(u'aldryn_newsblog_newsblogconfig', 'exclude_featured',
                      self.gf('django.db.models.fields.PositiveSmallIntegerField')(default=0, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'NewsBlogLatestArticlesPlugin.exclude_featured'
        db.delete_column(u'aldryn_newsblog_newsbloglatestarticlesplugin', 'exclude_featured')

        # Deleting field 'NewsBlogConfig.exclude_featured'
        db.delete_column(u'aldryn_newsblog_newsblogconfig', 'exclude_featured')
    ...
    models = {
        ...
        u'aldryn_newsblog.newsblogconfig': {
            ...
            'exclude_featured': ('django.db.models.fields.PositiveSmallIntegerField', [], {'default': '0'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
