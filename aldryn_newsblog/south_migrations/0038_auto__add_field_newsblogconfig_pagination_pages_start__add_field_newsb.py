...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'NewsBlogConfig.pagination_pages_start'
        db.add_column(u'aldryn_newsblog_newsblogconfig', 'pagination_pages_start',
                      self.gf('django.db.models.fields.PositiveIntegerField')(default=10),
                      keep_default=False)

        # Adding field 'NewsBlogConfig.pagination_pages_visible'
        db.add_column(u'aldryn_newsblog_newsblogconfig', 'pagination_pages_visible',
                      self.gf('django.db.models.fields.PositiveIntegerField')(default=4),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'NewsBlogConfig.pagination_pages_start'
        db.delete_column(u'aldryn_newsblog_newsblogconfig', 'pagination_pages_start')

        # Deleting field 'NewsBlogConfig.pagination_pages_visible'
        db.delete_column(u'aldryn_newsblog_newsblogconfig', 'pagination_pages_visible')
