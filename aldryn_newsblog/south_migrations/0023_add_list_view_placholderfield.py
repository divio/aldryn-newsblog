...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column(u'aldryn_newsblog_newsblogconfig', 'list_view_placeholder',
    ...
    def backwards(self, orm):
        ...
        # Deleting field 'NewsBlogConfig.list_view_placeholder'
        db.delete_column(u'aldryn_newsblog_newsblogconfig', 'list_view_placeholder_id')
