...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Article.featured_image'
        db.alter_column(u'aldryn_newsblog_article', 'featured_image_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['filer.Image'], null=True, on_delete=models.SET_NULL))

    def backwards(self, orm):

        # Changing field 'Article.featured_image'
        db.alter_column(u'aldryn_newsblog_article', 'featured_image_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['filer.Image'], null=True))
