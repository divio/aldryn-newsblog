...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'NewsBlogLatestArticlesPlugin.cache_duration'
        db.add_column(u'aldryn_newsblog_newsbloglatestarticlesplugin', 'cache_duration',
                      self.gf('django.db.models.fields.PositiveSmallIntegerField')(default=0),
                      keep_default=False)

        # Adding field 'NewsBlogRelatedPlugin.cache_duration'
        db.add_column(u'aldryn_newsblog_newsblogrelatedplugin', 'cache_duration',
                      self.gf('django.db.models.fields.PositiveSmallIntegerField')(default=0),
                      keep_default=False)

        # Adding field 'NewsBlogArchivePlugin.cache_duration'
        db.add_column(u'aldryn_newsblog_newsblogarchiveplugin', 'cache_duration',
                      self.gf('django.db.models.fields.PositiveSmallIntegerField')(default=0),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'NewsBlogLatestArticlesPlugin.cache_duration'
        db.delete_column(u'aldryn_newsblog_newsbloglatestarticlesplugin', 'cache_duration')

        # Deleting field 'NewsBlogRelatedPlugin.cache_duration'
        db.delete_column(u'aldryn_newsblog_newsblogrelatedplugin', 'cache_duration')

        # Deleting field 'NewsBlogArchivePlugin.cache_duration'
        db.delete_column(u'aldryn_newsblog_newsblogarchiveplugin', 'cache_duration')
    ...
    models = {
        ...
        u'aldryn_newsblog.article': {
            ...
            'featured_image': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['filer.Image']", 'null': 'True', 'on_delete': 'models.SET_NULL', 'blank': 'True'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
        ...
        u'aldryn_newsblog.newsblogconfig': {
            ...
            'exclude_featured': ('django.db.models.fields.PositiveSmallIntegerField', [], {'default': '0', 'blank': 'True'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            ...
            'pagination_pages_start': ('django.db.models.fields.PositiveIntegerField', [], {'default': '10'}),
            'pagination_pages_visible': ('django.db.models.fields.PositiveIntegerField', [], {'default': '4'}),
            ...
            'template_prefix': ('django.db.models.fields.CharField', [], {'max_length': '20', 'null': 'True', 'blank': 'True'}),
